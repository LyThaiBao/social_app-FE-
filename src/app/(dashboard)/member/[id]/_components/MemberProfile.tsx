          ...
          <div className="relative flex flex-col md:flex-row items-end gap-6 -mt-16 md:-mt-20">
            ...
            <div className="flex-1 mb-2">
              ...
              <div className="flex flex-wrap gap-4 mt-2 text-gray-500 text-sm">
                ...
                <span className="flex items-center gap-1">
                  <Calendar size={16} /> Tham gia tháng 4, 2026
                </span>
              </div>
            </div>
            ...
            <div className="flex gap-3 mb-2 w-full md:w-auto">
              <button className="flex-1 md:flex-none flex items-center justify-center gap-2 px-6 py-2.5 bg-blue-600 text-white font-semibold rounded-xl hover:bg-blue-700 transition-all active:scale-95 shadow-md shadow-blue-100">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-gray-700">{data.birthDay}</p>
                </div>
              </div>
